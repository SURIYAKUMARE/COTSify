...
import {
  Github, Linkedin, Mail, ExternalLink, Code2, Cpu, Brain,
...
function MemberCard({ member }: { member: typeof TEAM[0] }) {
  ...
  return (
    <div className={`group relative bg-gray-900/60 border ${member.border} rounded-3xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:${member.glow} hover:-translate-y-1`}>
      {/* Gradient top bar */}
